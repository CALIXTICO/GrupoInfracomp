...
public class Fabrica {
	...
	public static void creacionProcesosAzules(int numProcesosPorEtapa, int numProductosPorProceso)
	{
		...
		{
			procesosAzules[i] = new Azul(1, numProductosPorProceso, null, buzon1);
		}
		
		//Creación Etapa 2
		for (int i = numProcesosPorEtapa-1; i < (numProcesosPorEtapa-1)*2; i++)
		{
			procesosAzules[i] = new Azul(2, numProductosPorProceso, buzon1, buzon2);
		}
		
		//Creación Etapa 3
		for (int i = (numProcesosPorEtapa-1)*2; i < (numProcesosPorEtapa-1)*3; i++)
		{
			procesosAzules[i] = new Azul(3, numProductosPorProceso, buzon2, buzonFinal);
		}
